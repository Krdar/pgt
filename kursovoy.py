...
if page == "Задание 3":
        ...
        st.caption('Давление полного торможения перед нерегулируемой ступенью p0 = 12.445 МПа')
        st.caption('Энтальпия полного торможения перед первой нерегулируемой ступенью h0 = 3465.095 кДж/кг')
        st.caption('Расход пара в первую нерегулируемую ступень G0 = 176.3289 кг/с')
        st.caption('Давление за ЦВД pz = 2.739 МПа')
        st.caption('etaoi = 0.748')
        st.caption('Количество ступеней ЦВД прототипа = 7')
